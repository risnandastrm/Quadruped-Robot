...
uint8_t Mscale = MFS_14BITS; // MFS_14BITS or MFS_16BITS, 14-bit or 16-bit magnetometer resolution
...
void readMagData(int16_t * destination)
{
  ...
  if(readByte(AK8963_ADDRESS, AK8963_ST1) & 0x01) { // ThisThread::sleep_for for magnetometer data ready bit to be set
...
{  
 ...
 // wake up device
  ...
  ThisThread::sleep_for(0.1); // Delay 100 ms for PLL to get established on x-axis gyro; should check for PLL ready interrupt  
...
// Configure FIFO to capture accelerometer and gyro data for bias calculation
  ...
  ThisThread::sleep_for(0.04); // accumulate 40 samples in 80 milliseconds = 480 bytes
...
// Configure the accelerometer for self-test
   ...
   ThisThread::sleep_for(25); // Delay a while to let the device stabilize
